const games = [
    { name: "Aero Fighters", rom: "aerof.smc", thumb: "aerof.avif" },
    { name: "Bugs Bunny Rabbit Rampage", rom: "bb-rabbit-ramp.sfc", thumb: "bb-rabbit-ramp.avif" },
    { name: "Choplifter III", rom: "chop3.smc", thumb: "chop3.avif" },
    { name: "Chrono Trigger", rom: "chrono.sfc", thumb: "chrono.avif" },
    { name: "Donkey Kong Country", rom: "dkc1.sfc", thumb: "dkc1.avif" },
    { name: "Donkey Kong Country 2", rom: "dkc2.sfc", thumb: "dkc2.avif" },
    { name: "Donkey Kong Country 3", rom: "dkc3.sfc", thumb: "dkc3.avif" },
    { name: "F-Zero", rom: "fzero.smc", thumb: "fzero.avif" },
    { name: "Final Fight", rom: "ff.smc", thumb: "ff.avif" },
    { name: "Final Fight 2", rom: "ff2.smc", thumb: "ff2.avif" },
    { name: "Final Fight 3", rom: "ff3.smc", thumb: "ff3.avif" },
    { name: "Goof Troop", rom: "gtroop.sfc", thumb: "gtroop.avif" },
    { name: "International Superstar Soccer", rom: "iss.smc", thumb: "iss.avif" },
    { name: "International Superstar Soccer Deluxe", rom: "iss-deluxe.sfc", thumb: "iss-deluxe.avif" },
    { name: "Mega Man X", rom: "mmx.sfc", thumb: "mmx.avif" },
    { name: "Mortal Kombat", rom: "mk.smc", thumb: "mk.avif" },
    { name: "Mortal Kombat II", rom: "mk2.smc", thumb: "mk2.avif" },
    { name: "NBA Jam", rom: "nbajam.smc", thumb: "nbajam.avif" },
    { name: "Rock n' Roll Racing", rom: "rarr.smc", thumb: "rarr.avif" },
    { name: "Samurai Shodown", rom: "samuraisho.smc", thumb: "samuraisho.avif" },
    { name: "Side Pocket", rom: "sidepock.smc", thumb: "sidepock.avif" },
    { name: "Street Fighter II", rom: "sf2.sfc", thumb: "sf2.avif" },
    { name: "Street Fighter II Turbo", rom: "sf2t.smc", thumb: "sf2t.avif" },
    { name: "Sunset Riders", rom: "sunset-riders.sfc", thumb: "sunset-riders.avif" },
    { name: "Super Mario All-Stars", rom: "mario-allstars.sfc", thumb: "mario-allstars.avif" },
    { name: "Super Mario Kart", rom: "mario-kart.sfc", thumb: "mario-kart.avif" },
    { name: "Super Mario World", rom: "smw.sfc", thumb: "smw.avif" },
    { name: "Super Soccer", rom: "ssa2.smc", thumb: "ssa2.avif" },
    { name: "The Mask", rom: "mask.sfc", thumb: "mask.avif" },
    { name: "TMNT IV: Turtles in Time", rom: "teenagemtt.smc", thumb: "teenagemtt.avif" },
    { name: "Top Gear", rom: "top-gear.sfc", thumb: "top-gear.avif" },
    { name: "Top Gear 2", rom: "topgear2.smc", thumb: "topgear2.avif" },
    { name: "Ultimate Mortal Kombat 3", rom: "umk3.sfc", thumb: "umk3.avif" },
    { name: "WWF WrestleMania: The Arcade Game", rom: "wwftag.sfc", thumb: "wwftag.avif" },
    { name: "Zelda: A Link to the Past", rom: "zelda-alttp.sfc", thumb: "zelda-alttp.avif" }
];
